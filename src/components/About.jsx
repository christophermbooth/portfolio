  ...
  return (
    <div className="content">
      <div>
        ...
        <p>Hi, I'm Chris! and I am a software developer based in New Orleans, LA with an incredible passion for technology and how
        ...
        <p>
          ...
          server hardware for home use, spun up multiple services all in virtualized environments, and generally taught myself everything I know.  Even this website is self hosted.
        </p>
        <p>
